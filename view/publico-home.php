...
<head>
    ...
    <body>
        ...
        <section class="about" id="about">
            ...
            <div class="container">
                <div class="im">
                    <img src="Imagens/nossa ong.png" alt="">
                </div>
        ...
        <section class="section_container room_container">
            <div class="titu">
                <h2 class="section_header"> Ajudamos os animaisinhos a ter um lar, um alimento de qualidade e os tratamentos necessarios com suas doações.</h2>
            </div>
            <div class="room_grid">
                <div class="room_card">
        ...
        <footer id="contact">
            <div class="container">
                ...
                <div class="f-container">
                    <h2>Ajuda</h2>
                    <p> Tem alguma duvida ou gostaria de falar com algum dos nossos integrantes?</p>
                    <input type="text" placeholder="Informe seu nome...">
                    <input type="text" placeholder="Informe seu email...">
                    <input type="text" placeholder="Informe seu numero de celular...">
